        ...
        <div class="sub_menu">
            <ul>
                ...
                <li class="item" id="tourboard">
                    <a href="<%=request.getContextPath() %>/reservation/ReservationExhibits" class="btn"><i class="fas fa-ticket-alt"></i>레저 | 체험 </a>
                </li>
                <li class="item" id="tourboard">
                    <a href="<%=request.getContextPath() %>/reservation/ReservationExperience" class="btn"><i class="fas fa-ticket-alt"></i>전시 | 관람 </a>
                </li>
            </ul>
        </div>
    </div>
