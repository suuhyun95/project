...
<body>
	<header>
		<div class="head_center">
			<img class ="header_logo" src="<%=request.getContextPath()%>/images/main/GOGO_GUNSAN_LOGO.png" alt="고고군산 로고">
			...
			<%}%>
				<nav class="header_menu">
					<a href="<%=request.getContextPath()%>/intro/GunsInfoGo">관광지 소개</a>
					<a href="<%=request.getContextPath()%>/corse/MuseumCorseGo">추천코스</a>
