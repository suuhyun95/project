...
<section id="boardView">
	...
	<div class="contents-main-container">
		<div class="sub-contents-inner">
			...
			<%if(memberLoggedIn!=null && (board.getAdminBoardWriter().equals(memberLoggedIn.getMemberName())||"A".equals(memberLoggedIn.getGrade()))){ %>
				<td>
							...
							<div class="board-file">
								<table>
									<tr>
										<th>첨부파일</th>
										<td>
											<% if(board.getAdminOriginalFileName()!=null) { %> <!-- 첨부파일이 있을경우만, 이미지와 함께 original파일명 표시 -->
											<a
...
function fileDownload(oName, rName){
	...
	location.href = "<%=request.getContextPath()%>/board/admin_board/adminBoardFileDownload"+ "?oName=" + oName + "&rName=" + rName;
